...
export default function CoursesHero5() {
  ...
  return (
    <section className="bg-white text-black py-20 relative overflow-hidden">
      {/* Background animation waali ah */}
      {/* <div className="absolute inset-0 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 animate-pulse opacity-10 blur-2xl"></div> */}
      ...
      <div className="relative container mx-auto px-6 text-center">
        ...
        >
          <input
            ...
            className="w-full px-4 py-3 rounded-l-full text-blue-900 font-semibold focus:outline-none border-yellow-300"
          />
          <button
            type="submit"
